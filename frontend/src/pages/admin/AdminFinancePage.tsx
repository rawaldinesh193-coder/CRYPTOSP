...
export const AdminFinancePage: React.FC = () => {
  ...
  const [tab, setTab] = useState<'deposit' | 'reversal'>('deposit');
            ...
            <form onSubmit={handleAdminCredit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  value={depositReason}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDepositReason(e.target.value)}
            ...
            <form onSubmit={handleAdminReversal} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  value={reversalTxId}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setReversalTxId(e.target.value.trim())}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setReversalReason(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/15 text-white font-sans text-sm focus:outline-none"
