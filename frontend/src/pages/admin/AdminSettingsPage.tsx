          ...
          <form onSubmit={handleSaveSettings} className="space-y-6">
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPhoenixCoinPriceUsd(e.target.value)}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPlatformFeePercentage(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/15 text-white font-mono text-sm focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMaintenanceMode(e.target.checked)}
