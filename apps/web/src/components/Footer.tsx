...
import { GlassButton } from '@cryptosp/ui';

export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-black border-t border-white/10 overflow-hidden pt-20 pb-12">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/[0.01] to-black pointer-events-none" />

      {/* Landing Page CTA Section (Section 57 compliance) */}
      <div className="max-w-7xl mx-auto px-6 mb-20">
        <div className="relative rounded-3xl p-12 md:p-20 bg-gradient-to-b from-white/[0.05] to-white/[0.01] border border-white/15 backdrop-blur-2xl shadow-[0_0_80px_rgba(255,255,255,0.03)] overflow-hidden text-center">
          ...
          <p className="mt-6 text-lg text-neutral-400 font-sans max-w-2xl mx-auto">
            A modern digital wallet built for fast, transparent, and secure value transfer across the Phoenix ecosystem.
          </p>
