...
import { GlassCard, GlassButton, MarketTicker } from '@cryptosp/ui';
import { Flame, Shield, Zap, QrCode, ArrowRight, Layers, Lock, RefreshCw, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#030305] text-white overflow-x-hidden bg-liquid-mesh">
      ...
      <section className="relative pt-36 pb-24 px-6 max-w-7xl mx-auto text-center">
        ...
        <div className="mt-16 relative max-w-5xl mx-auto">
          <div className="absolute -inset-1 bg-gradient-to-r from-white/10 via-amber-500/10 to-white/10 rounded-3xl blur-2xl opacity-50 pointer-events-none" />
      ...
      {/* Security & Double-Entry Ledger Section */}
      <section className="py-24 px-6 max-w-7xl mx-auto border-t border-white/10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="px-3 py-1 rounded-full bg-white/5 text-neutral-300 border border-white/10 text-xs font-mono uppercase tracking-widest">
          ...
          <p className="mt-4 text-neutral-400">
            Never trust floating points or direct balance mutations. Cryptosp executes every movement through PostgreSQL atomic transactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <GlassCard className="p-8">
            ...
            <h3 className="text-xl font-bold text-white font-serif">Double-Entry Accounting</h3>
            <p className="mt-3 text-sm text-neutral-400 leading-relaxed">
              Every transaction creates debit and credit ledger rows. Balances are derived from historical ledger summation rather than direct balance edits.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-8">
            ...
            <h3 className="text-xl font-bold text-white font-serif">Idempotency Protection</h3>
            <p className="mt-3 text-sm text-neutral-400 leading-relaxed">
              Every payment request includes unique idempotency key headers. Retrying network requests will never create duplicate money movements.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-8">
            ...
            <h3 className="text-xl font-bold text-white font-serif">Compensating Reversals</h3>
            <p className="mt-3 text-sm text-neutral-400 leading-relaxed">
              Financial history is never deleted or overwritten. Administrative reversals create compensating debit/credit entries with mandatory audit logs.
            </p>
          </GlassCard>
        </div>
      </section>
